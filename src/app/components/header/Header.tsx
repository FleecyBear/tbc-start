  ...
  return (
    <header className="fixed top-0 left-0 w-full h-20 bg-white flex justify-between items-center z-50 shadow-md dark:bg-gray-900 border-b-4 border-blue-500 px-9 text-sm">
      ...
      <div className="relative">
        ...
        {/* Hamburger menu */}
        <div
          className="group flex h-8 w-8 cursor-pointer items-center justify-center rounded-3xl bg-transparent p-2"
          onClick={toggleMenu}
        >
        ...
        <div
          className={`absolute right-0 mt-2 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 flex flex-col gap-3 z-10 select-none transition-opacity duration-300 ${
